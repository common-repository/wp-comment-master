...
== Description ==
= Special note =
I "addopted" this plugin because it was left behind by the old developer. As a long time user I will provide an update very soon and in the meantime post your questions and comments to the forum.
...
= Something to note: =
* SEO:pagination still enables your comment to be indexed by Search Engines like Google
...
1. Upload the entire `wp-comment-master` folder to the `/wp-content/plugins/` directory.
